...
const MvTheme MV_THEME_DARK = {
    ...
    .trace_field     = C(255, 196,  84),   /* total field — amber       */
    .trace_depth     = C( 92, 178, 255),   /* towfish depth — blue      */
    .trace_signal    = C(122, 214, 154),   /* signal strength — green   */
    .trace_aux       = C(198, 142, 232),   /* altitude/aux — violet     */
    .scrim           = CA(  8,   9,  12, 190),
};

const MvTheme MV_THEME_LIGHT = {
    .is_light        = true,
    ...
    .trace_field     = C(184, 116,   8),   /* total field — amber       */
    .trace_depth     = C( 24,  96, 200),   /* towfish depth — blue      */
    .trace_signal    = C( 26, 132,  76),   /* signal strength — green   */
    .trace_aux       = C(122,  60, 176),   /* altitude/aux — violet     */
    .scrim           = CA( 30,  36,  46, 120),
};

void mv_theme_apply(struct nk_context *ctx, const MvTheme *t, float scale)
{
