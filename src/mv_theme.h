 ...
 */
/*
 * mv_theme.h — colour roles and Nuklear styling
 *
...
typedef struct {
    ...
    struct nk_color trace_field;
    struct nk_color trace_depth;
    struct nk_color trace_signal;
    struct nk_color trace_aux;
    struct nk_color scrim;         /* dims the page behind a dialog */
} MvTheme;

extern const MvTheme MV_THEME_DARK;
extern const MvTheme MV_THEME_LIGHT;
